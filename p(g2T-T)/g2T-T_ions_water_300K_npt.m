...
read_data               g2T-T_ions_water.data
...
pair_coeff  12  12      0.1004      4.30   #Cl
pair_coeff  13  13      0.1076      2.31   #Na
...
dihedral_coeff 26 table PgT_troisi.pot DIH_gTgT       # 4   2   2   4 gT-gT dihedral
dihedral_coeff 27 table PgT_troisi.pot DIH_TgT        # 4   2   2   8 T-gT dihedral
...
dump           RTlmp all atom 2500 g2T-T_ions_water_new.lammpstrj
dump_modify    RTlmp image yes
dump_modify    RTlmp sort id

dump           RT2 all dcd 2500 g2T-T_ions_water_new.dcd
dump_modify    RT2 sort id
dump_modify    RT2 unwrap yes

###############################################################################
fix            2 all npt temp 300.0 300.0 150.0 tchain 1 iso 1.0 1.0 2000.0
...
write_data     g2T-T_ions_water_new.data nocoeff
